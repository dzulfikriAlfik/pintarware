...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Prisma / Drizzle ORM", highlight: true },
  ...
  },
  {
    title: "DevOps & Tools",
    icon: Cloud,
    description: "Deploying and maintaining application infrastructure",
    gradient: "from-azure-200 to-azure",
    skills: [
      { name: "Docker", highlight: true },
      { name: "Git / GitHub", highlight: true },
      { name: "CI/CD Pipelines", highlight: false },
      { name: "AWS / Vercel", highlight: true },
